...
図柄においては複数のモデルを用意することによって表現の幅を広げる予定です。
...
プロジェクトの性質上複数のモデルを提供可能ですので、モデル・キャラクター等をWalletアバターNFTに組み込んでいただける方はコミュニティDiscordの[NFT部](https://discord.com/channels/705052448418693180/897682225913528420)にてご連絡ください。
