...
image_alt = ""
layout = "post"
subtitle = "Yamatoのメインネットローンチ、バルクオークションツールのネーミングコンペ開催"
tags = "オフィシャルアナウンス"
thumb_image = "/images/blog/DFGC_logo_banner.webp"
thumb_image_alt = ""
title = "2023年7月度開発活動報告"
[seo]
description = ""
title = ""
[[seo.extra]]
...
1 社目の監査レポートのファイナライズが完了し、公開されました。\
https://blockapex.io/yamato-protocol-audit-report/

価格フィードに関しての追加監査についても近日公開予定です。
...
すべてのコントラクトとデプロイ手順の調整が完了し、メインネットローンチされました。
各種リソースへのリンクは以下です。
...
次に V1.5 の YMT、veYMT 発行に向けた調査・開発を行います。
...
[dev-app.yamato.fi](https://dev-app.yamato.fi/)はテストネットでの追加機能の検証用インターフェースとして稼働しています。
...
コミュニティでの機能検証が完了したため、Mint の制限（DFGC の Discord 参加）を撤廃しました。
どなたでも Mint が可能です。

バックエンド・フロントエンドの改修で UX の改善をしています。
今後も引き続き機能追加と、DFGC コミュニティ外への一般開放を進めます。
...
マークルディストリビューターをパッケージ化する際の名称を決めるコンペティションを開催しました。

投票の結果、マークルディストリビューターの名称は「Megumi」に決定いたしました。

応募・投票してくださった皆様ありがとうございました。

## ーオークションプラットフォームー

オークションプラットフォームは用意されたテンプレートに従ったオークションをノーコードで立ち上げられるプラットフォームです。
