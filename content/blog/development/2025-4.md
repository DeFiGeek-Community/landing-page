...
image_alt = ""
layout = "post"
subtitle = "Yamato V1.5のリリース"
tags = "オフィシャルアナウンス"
thumb_image = "/images/blog/DFGC_logo_banner.webp"
thumb_image_alt = ""
title = "2025年4月度開発活動報告"
[seo]
description = ""
title = ""
[[seo.extra]]
...
開発が完了した V1.5 の YMT、veYMT について、メインネットへ展開しました。\
[ve.yamato.fi](https://ve.yamato.fi/)にて YMT 関連の操作をすることができます。
...
Yamato 運用開始時からの借入量・担保率に基づいたスコアから各ユーザーごとの割当量が確定しました。\
2025/5/10 から 2026/5/10 までの一年間線形べスティングとなります。\
請求は任意のタイミングで行うことができます。

#### チェックポイント

2025/7/25 から始まる YMT 排出についてはオンチェーンにて記録されるスコアを基に按分されます。\
それに伴い、現時点からのスコア記録を開始するチェックポイント機能が設置されています。\
こちらは ve ページにログインした際に表示されるポップアップからチェックポイントを記録するか Yamato において借り入れなどの任意の操作を行うことで更新されます。

**早く行うほどスコアが多く蓄積されるので、早めの対応を推奨します。**
