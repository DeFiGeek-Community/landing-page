...
image_alt = ""
layout = "post"
subtitle = "Yamato V1.5のリリース準備、初期リワードの割り当て"
tags = "オフィシャルアナウンス"
...
開発が完了した V1.5 の YMT、veYMT について、メインネットへ展開の準備が完了しました。\
初期リワード割当などの準備が整い次第ユーザー向けにインターフェースが展開されます。
