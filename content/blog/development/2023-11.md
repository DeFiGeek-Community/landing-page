...
image_alt = ""
layout = "post"
subtitle = "punodwoɔの新規プールローンチ、UI改善"
tags = "オフィシャルアナウンス"
thumb_image = "/images/blog/DFGC_logo_banner.webp"
thumb_image_alt = ""
title = "2023年11月度開発活動報告"
[seo]
description = ""
title = ""
[[seo.extra]]
...
- [日本語と英語の言語切り替え機能](https://github.com/DeFiGeek-Community/comet-interface/issues/2)
- [USD ドルから JPY 円への表記切り替え機能](https://github.com/DeFiGeek-Community/comet-interface/issues/3)
- [最大値設定と全額操作のユーザーインタフェース改善](https://github.com/DeFiGeek-Community/comet-interface/issues/10)
