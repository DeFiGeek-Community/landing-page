...
image_alt = ""
layout = "post"
subtitle = "Punodwoɔのロゴ決定、UI追加開発"
tags = "オフィシャルアナウンス"
thumb_image = "/images/blog/DFGC_logo_banner.webp"
thumb_image_alt = ""
title = "2024年4月度開発活動報告"
[seo]
description = ""
title = ""
[[seo.extra]]
...
- [PND 報酬に未確定の報酬量も表示する](https://github.com/DeFiGeek-Community/comet-interface/issues/16)

以下の対応を予定しています。

- [プール一覧ページに預入 APR、借入 APR、預金貸出率を追加](https://github.com/DeFiGeek-Community/comet-interface/issues/18)
