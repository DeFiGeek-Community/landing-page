...
image_alt = ""
layout = "post"
subtitle = "Concluded naming competition for Merkle Distributors, launching naming competion for Bulk Auction tool"
tags = "オフィシャルアナウンス"
thumb_image = "/images/blog/DFGC_logo_banner.webp"
thumb_image_alt = ""
title = "Development Report June 2023"
[seo]
description = ""
title = ""
[[seo.extra]]
...
We are on track to address the multi-sig management practices for deployments and upgrades hence we have tested contracts deployment & upgrade on Goerli & Sepolia network.

The selection and logic of the ETH-JPY price feed oracle has adjusted and deployed the updated contract to reflect Chainlink price feed on Sepolia network. Once the latest code audit has completed we commence to mainnet deployment.
...
The draft docs are tentatively published in [Gitbook](https://defigeek.gitbook.io/yamato-protocol/4zgf5zCGE21eAieiUqMz/). If there are any typos or unclear points, please advise us in [Discord](https://discord.com/channels/705052448418693180/899916069161041931).
...
URL：[https://www.yabumi.defigeek.xyz/en#](https://www.yabumi.defigeek.xyz/en#)
...
Yabumi has officially launched on mainnet. Please vist here and mint Yabumi NFT.

Currently we are improving the UX with backend and frontend fixes. We continue to add features and make the site available to the public outside of the DFGC community.
...
PoC testing has completed however the environment is still up. Please use it for any testing.
...
Here is the Discord’s channel [payroll-nft-ama](https://discord.com/channels/705052448418693180/1075601594827149383) to report issues or suggestions from those who has participated in the testing.
...
The naming competition to select official name for the product package has concluded.  
As a result of community voting, the product name was decided to be "Megumi".

Thank you to everyone who contributed to the competition and voting.

## -Bulk Auction Tool-

Bulk Auction Tool is a no-code token launchpad.

It is a fair auction platform where users bid using ETH during the token sale period. The allocated share will be the ratio of the user's bid to the total bid amount.

V1: Bid in ETH & sale tokens are ERC20.
V2: Bid in ERC20 a&nd sale tokens are multi-standardized (e.g., ERC721).

Contract specifications are being finalized and developed, UI is under development.

### Naming Competition

We are holding a competition to name our bulk auction tool.

Please visit Discord's general forum to join first round of selection voting. 
