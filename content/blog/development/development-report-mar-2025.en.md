...
image_alt = ""
layout = "post"
subtitle = "Frontend hosting changed, docs updated"
tags = "オフィシャルアナウンス"
thumb_image = "/images/blog/DFGC_logo_banner.webp"
thumb_image_alt = ""
title = "Development Report Mar 2025"
[seo]
description = ""
title = ""
[[seo.extra]]
...
Due to a change in the specifications of the hosting site previously used for Yamato and Punodwoɔ, we have migrated the hosting to AWS, which is also used for Yabumi.

There are no changes to the URLs, so you can continue using the services as before.

The services are currently running smoothly in the new environment, but if you experience any issues such as display problems or being unable to access the site, please try clearing your browser cache and checking again.

### Docs

We are currently organizing and expanding the documentation for various Dapps, and releasing them progressively.

Detailed instructions, such as how to claim $YMWK, are included in the documentation, so please refer to them when completing the process.
