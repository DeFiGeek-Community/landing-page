...
image_alt = ""
layout = "post"
subtitle = "Yamato ver 1.5 launch & early user reward airdrop"
tags = "オフィシャルアナウンス"
thumb_image = "/images/blog/DFGC_logo_banner.webp"
thumb_image_alt = ""
title = "Development Report Apr 2025"
[seo]
description = ""
title = ""
[[seo.extra]]
...
Development of V1.5 YMT and veYMT has been completed, and preparations for mainnet deployment are now finalized.

Once the initial reward allocations and other preparations are complete, the user interface will be made available.
...
For all early reward recipients please check the following for accuracy:

- https://github.com/DeFiGeek-Community/yamato/blob/v1.5/scripts/events/extractedEvents.json

  -  Verify that there are no missing or extra events related to your address.

- https://github.com/DeFiGeek-Community/yamato/blob/v1.5/scripts/events/Yamato_v1_distributions.csv

  - Confirm that the allocated amount based on your score is correct.


Once these allocations are confirmed to be accurate, the ve interface will be deployed.
