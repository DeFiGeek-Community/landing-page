...
image_alt = ""
layout = "post"
subtitle = "punodwoɔのローンチ、Yamawakeのロゴコンペ"
tags = "オフィシャルアナウンス"
thumb_image = "/images/blog/DFGC_logo_banner.webp"
thumb_image_alt = ""
title = "2023年9月度開発活動報告"
[seo]
description = ""
title = ""
[[seo.extra]]
...
パラメータの調整とデプロイスクリプトの作成等を完了し、CJPY プールをメインネットにローンチしました。

次に ETH,USDC,crvUSD プールを立ち上げる予定です。

このデプロイスクリプト開発はプロトコルの初期開発報酬割り当て対象となりますので、ぜひ取り組んでください。
...
CompoundV3 フォークプールのネーミングコンペティションを総合フォーラムの CompoundV3 ネーミングコンペティションスレッドにて開催していました。

[決戦投票](https://snapshot.org/#/defigeek.eth/proposal/0x835cecf9c712bf1aeef5e6b588184d95522a1394cc97e48c486714fa1f2b4f49)の結果、名称は punodwoɔ に決まりました。
